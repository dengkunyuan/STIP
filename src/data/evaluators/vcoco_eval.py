...
class VCocoEvaluator(object):
    ...
    def update(self, outputs):
        ...
        for img_num, img_id in enumerate(img_ids):
            ...
            gt_h_act = target['inst_actions'][gt_h_inds, :self.num_human_act].cpu().numpy() ## self.num_human_act=26, for filtering GT
            ...
            self.role_eval1.add_data(hbox, obox, score, gt_h_box, gt_h_act, gt_p_box, gt_p_act) # gt_h_act: Nx26, gt_p_act: Nx25
